...
app.controller('MainController', ['$scope', function($scope) {
   $scope.page = [
        ...
        {   entry: 'Mice', 
            ...
            head: "Shopping > Mice", 
            picture: "img/g502.png", 
            shoppable: true },
        {   entry: "Keyboards", 
            url: "pages/shopitem.html", 
            head: "Shopping > Keyboards", 
            picture: "img/blackwid.png", 
            shoppable: true },
        {   entry: "Headsets", 
            url: "pages/shopitem.html", 
    ...
    $scope.Mice = [
        {   brand: "razer", 
            model: "naga", 
            picture: "img/naga.png", 
            price: "80" },
        {   brand: "razer", 
            model: "deathadder", 
            picture: "img/deathadder.png", 
            price: "60" },
        {   brand: "razer", 
            model: "mamba", 
            picture: "img/mamba.png", 
            price: "150" },
        {   brand: "logitech", 
            model: "g502 proteus core", 
            picture: "img/g502.png", 
            price: "75" },
        {   brand: "logitech", 
            model: "g500s", 
            picture: "img/g500s.png", 
            price: "80" },
        {   brand: "mad catz", 
            model: "rat 9", 
            picture: "img/rat9.png", 
            price: "90" }
    ];
    $scope.Keyboards = [
        {   brand: "razer", 
            ...
            price: "100" },
        {   brand: "razer", 
            model: "blacwidow chroma", 
            picture: "img/blackwidchroma.png", 
            price: "150" },
        {   brand: "logitech", 
            model: "g910 orion spark", 
            picture: "img/g910.png", 
            price: "180" },
        {   brand: "logitech", 
            model: "g710", 
            picture: "img/g710.png", 
            price: "130" },
        {   brand: "daskeyboard", 
            model: "g500s", 
            picture: "img/dasSPro.png", 
            price: "80" }
    ];
    $scope.Headsets = [
        {   brand: "tritton", 
            model: "tritton pro+", 
            picture: "img/tritton.png", 
            price: "130" },
        {   brand: "steelseries", 
            model: "siberia v2", 
            picture: "img/sv2.png", 
        ...
        {   brand: "logitech", 
            model: "g933", 
            picture: "img/g933.png", 
            price: "200" },
        {   brand: "logitech", 
            model: "g930", 
            picture: "img/g930.png", 
            price: "160" },
        {   brand: "logitech", 
            model: "g430", 
            picture: "img/g430.png", 
